...
@Component
@Profile(Profiles.NOT_H2)
public class PostgreSqlSelector implements AclSqlSelector {
    ...
    private final static String OBJECT_IDENTITY_PRIMARY_KEY_QUERY = "select acl_object_identity.id from acl_object_identity, acl_class "
            ...
            + "and acl_object_identity.object_id_identity = UUID(?)";
    private final static String CLASS_IDENTITY_QUERY = "SELECT lastVal()";
    private final static String SID_IDENTITY_QUERY = "SELECT lastVal()";
    ...
    private final String FIND_CHILD_QUERY = "select obj.object_id_identity as obj_id, "
            ...
            + "and parent.object_id_identity = UUID(?) and parent.object_id_class = ("
            + "select id FROM acl_class where acl_class.class = ?)";

    private final String SELECT_CLAUSE_COLUMN = "select acl_object_identity.object_id_identity::varChar, "
            + "acl_entry.ace_order,  "
    ...
    private final String LOOKUP_OBJECT_IDENTITIES_WHERE_CLAUSE = "(acl_object_identity.object_id_identity = UUID(?) and acl_class.class = ?)";
